          ...
          <div className="flex items-center gap-4">
            {user ? (
              <>
                <Link
                  to="/"
                  className="text-gray-400 hover:text-white transition-colors flex items-center gap-1 text-sm hidden sm:flex"
                >
                ...
                <Link
                  to="/profile"
                  className="flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors bg-white/5 px-3 py-1.5 rounded-lg border border-white/5"
                >
