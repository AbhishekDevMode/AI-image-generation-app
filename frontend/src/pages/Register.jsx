...
const Register = () => {
  ...
  return (
    <div className="flex justify-center items-center h-[calc(100vh-80px)] py-10">
      <div className="glass-panel w-full max-w-md p-8 relative overflow-hidden">
        <div className="absolute top-0 left-0 -ml-16 -mt-16 w-32 h-32 bg-primary/30 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 -mr-16 -mb-16 w-32 h-32 bg-secondary/30 rounded-full blur-3xl"></div>
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <p className="text-gray-400 text-sm">Join NexusAI and get 10 free generations today</p>
        </div>
